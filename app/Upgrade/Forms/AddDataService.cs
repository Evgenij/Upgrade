...
{
    public partial class AddDataService : Form
    {
        [DllImport("Gdi32.dll")]
        ...
        private void AddDataService_Load(object sender, EventArgs e)
        {
            ...
            addServiceDataButton.Active1 = Design.mainColorOpacity;
            addServiceDataButton.Active2 = Design.mainColorOpacity;
            addServiceDataButton.StrokeColor = Design.mainColor;
        }
